 ...
 */
package com.sxp.hbase.security;
...
/**
 * This class provides util methods for task-hbase connector communicating with secured HBase.
 */
public class HBaseSecurityUtil {
	public static final String STORM_KEYTAB_FILE_KEY = "task.keytab.file";
	public static final String STORM_USER_NAME_KEY = "task.kerberos.principal";
