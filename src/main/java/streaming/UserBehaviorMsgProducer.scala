...
object UserBehaviorMsgProducerClient {
  ...
  def two(args: Array[String]): Unit = {
    if (args.length < 2) {
   ...
   def lanucher1(): Unit = {
     val param1 = "10.10.11.14:9092,10.10.11.15:9092,10.10.11.16:9092"
     val param2 = "SparkTest"
     new Thread(new UserBehaviorMsgProducer(param1, param2)).start()
   }
